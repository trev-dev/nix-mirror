...
(define-key *root-map* (kbd "e") "kitty nvim")
...
; (defcommand skynk-stop () ()
;   (slynk:stop-server 4008))

; (defcommand skynk-restart () ()
...
(run-shell-command
 "feh --bg-scale ~/Pictures/wallpapers/guix-checkered-16-9.jpg")
